...
*Limitations:*  
The data dictionary stated that there are only two categories for the 'Mode of Study' variable. Namely, full time and part time. However, upon analysis, a third category called Unknown, was found.  

Another limitation is that the sample size for certain units are too small to produce good results.
